...
background-image: url(https://www.amnh.org/var/ezflow_site/storage/images/media/amnh/shelf-life/episode-4/ep-4-holotype-tag/1842583-4-eng-US/ep-4-holotype-tag_full_1220.png)
...
knitr::include_graphics(here::here("figs", "thisIsBird.jpeg"))
```
]
...
.center[
```{r, echo=FALSE,eval=TRUE,out.width="75%",fig.retina=3}
knitr::include_graphics(here::here("figs", "fig_model_all2.png"))
```
]
